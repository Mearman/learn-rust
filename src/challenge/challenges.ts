...
export const CHALLENGES: readonly Challenge[] = [
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "In TypeScript, assigning an object creates another reference to it — both variables point to the same data. Rust moves ownership, so s becomes invalid after let t = s.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "In TypeScript, primitive values (numbers, strings, booleans) are copied on assignment. Rust works the same way for types that implement Copy — i32 is one of them.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "TypeScript lets you hold multiple references to the same object and mutate through any of them. Rust enforces exclusivity: at most one &mut reference may exist at a time.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "TypeScript lets you read and mutate an object through different references at the same time. Rust's borrow checker ensures shared and mutable borrows never overlap.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "TypeScript doesn't track reference lifetimes. Rust does, but smartly: a borrow ends at its last actual use (non-lexical), not at the closing brace. The shared borrow has ended before push_str takes a mutable one.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "TypeScript has const (no reassignment) and let (reassignable), but const objects can still have their properties mutated. Rust's let mut controls whether the binding itself can be mutated — without mut, even calling push is rejected.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "Modifying an array during a for...of loop in JavaScript can produce unexpected results but no error. Rust catches this at compile time: the loop's borrow and push's &mut overlap.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "JavaScript's garbage collector keeps objects alive as long as any reference exists. Rust has no GC, so the compiler must statically verify that references don't outlive the data they point to.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "TypeScript doesn't need lifetime annotations — the garbage collector handles object lifetimes. Rust structs holding references must declare lifetime parameters so the compiler can ensure the references outlive the struct.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "TypeScript's switch doesn't enforce exhaustiveness — you can miss cases without error (unless you use a never-based trick). Rust's match must be exhaustive; every enum variant must be handled.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "TypeScript uses optional chaining (?.) and nullish coalescing (??) for null handling. Rust's ? operator goes further: it returns early from the function on None, propagating the absence up the call stack.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "JavaScript propagates exceptions automatically through the call stack. Rust's ? requires the enclosing function's return type to accept the error — main() returning () doesn't.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "TypeScript has only one number type (number), so mixed-type arithmetic never happens. Rust has many integer types (u8, i32, etc.) and requires explicit casts between them.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "TypeScript doesn't allow redeclaring a let variable in the same scope — let x = 5; let x = 6; is an error. Rust's let creates a new binding each time, shadowing the previous one in the same scope.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "JavaScript closures capture variables by reference — the closure and outer code share the variable. Rust's move || takes ownership of captured variables, so s is moved into the closure and can't be used afterwards.",
    ...
    },
    {
        ...
        whyPerLanguage: {
            ...
            typescript: "TypeScript uses structural typing — any function matching the signature (x: number) => number is accepted. Rust's impl Trait hides the concrete type while guaranteeing it satisfies the trait.",
